    ...
    public Type AddServices(IServiceCollection services, ConfigurationManager configuration){
        ...
        services.AddDbContext<ApplicationDBContext>(options =>
              ...
              options.UseSqlServer(cnString);
                  ...
                  services.AddTransient<ISearchDataModifiedFile, SearchDataModifiedFile>();
                services.AddTransient<ISearchDataModifiedUser, SearchDataModifiedUser>();
                services.AddTransient<ISearchDataModifiedUserFile, SearchDataModifiedUserFile>();
