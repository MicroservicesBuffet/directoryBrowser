...
public class InsertDataApplicationDBContext: I_InsertDataApplicationDBContext{
   ...
   public interface ISearchDataModifiedFile {
    ...
    public  IAsyncEnumerable<ModifiedFile> ModifiedFileSimpleSearch_Contents(GeneratorFromDB.SearchCriteria sc,  byte[] value);
    public  IAsyncEnumerable<ModifiedFile> ModifiedFileSimpleSearchNull_Contents(GeneratorFromDB.SearchCriteria sc);
   ...
   public class SearchDataModifiedFile: ISearchDataModifiedFile{
    ...
    public  IAsyncEnumerable<ModifiedFile> ModifiedFileSimpleSearchNull_FullPathFile(GeneratorFromDB.SearchCriteria sc){
        ...
        //False
    public  IAsyncEnumerable<ModifiedFile> ModifiedFileSimpleSearch_Contents(GeneratorFromDB.SearchCriteria sc,  byte[] value){
         return ModifiedFileSimpleSearch(sc,eModifiedFileColumns.Contents,value.ToString());

    
    }
    public  IAsyncEnumerable<ModifiedFile> ModifiedFileSimpleSearchNull_Contents(GeneratorFromDB.SearchCriteria sc){
        return ModifiedFileSimpleSearch(sc,eModifiedFileColumns.Contents,null);
   ...
   public interface ISearchDataModifiedUser {
    ...
    public  IAsyncEnumerable<ModifiedUser> ModifiedUserSimpleSearch_NameUser(GeneratorFromDB.SearchCriteria sc,  long value);
